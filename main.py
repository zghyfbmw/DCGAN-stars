...
X_train = np.load('/Users/zhangguanghua/Desktop/Stampede/T0.npy')
...
generator.compile(loss='binary_crossentropy', optimizer=Adam(lr=0.000006, beta_1=0.5))
generator.summary()
...
discriminator.compile(loss='categorical_crossentropy', optimizer=Adam(lr=0.000006, beta_1=0.5))
...
gan_model.compile(loss='categorical_crossentropy', optimizer=Adam(lr=0.000006, beta_1=0.5))
gan_model.summary()

print("Pre-training generator...")
noise_gen = np.random.uniform(0, 1, size=(80000, 100))   # at (0,1) creates 10000 points
generated_images = generator.predict(noise_gen)

print('generated_images shape ----', generated_images.shape)

X = np.concatenate((X_train[:80000, :, :, :], generated_images))
y = np.zeros([160000, 2])
y[:80000, 1] = 1
y[80000:, 0] = 1
...
def train_for_n(nb_epoch=160000, batch_size=128):
